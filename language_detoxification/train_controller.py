...
if __name__ == '__main__':
    ...
    train_file_list = glob.glob('{}/*.pickle'.format(args.train_dir))
    eval_file_list = glob.glob('{}/*.pickle'.format(args.eval_dir))
...
#         scheduler.step()
        ...
        if args.output_dir is not None and epoch % args.save_step == 0:
            torch.save(model, '{}/epoch_{}.pt'.format(args.output_dir, epoch))
